	...
	public MongoDbFactory createService(MongoServiceInfo serviceInfo) {
		try {
			...
			if (cloudMongoConfiguration != null && cloudMongoConfiguration.getWriteConcern() != null) {
				...
				if ("NONE".equals(cloudMongoConfiguration.getWriteConcern())) {
					writeConcern = WriteConcern.NONE;
				}
				else if ("NORMAL".equals(cloudMongoConfiguration.getWriteConcern())) {
					writeConcern = WriteConcern.NORMAL;
				}
				else if ("SAFE".equals(cloudMongoConfiguration.getWriteConcern())) {
					writeConcern = WriteConcern.SAFE;
				}
				else if ("FSYNC_SAFE".equals(cloudMongoConfiguration.getWriteConcern())) {
