...
public class CloudDataSourceFactoryParserTest extends AbstractCloudParserTest {
	...
	public void testMySqlDataSourceDefinition() throws Exception {
		...
		String username = "uIKpwGOTgjfaQ";
		String password = "pu0xEgiy997kQ";
		String dbName = "d855c4a2468de494984f94e85255ce5d5";
		String mysqlServicePayload = CloudEnvironmentTestHelper.getMysqlServicePayload("5.1", "mysql", "127.0.0.1", 3306,
				username, password, dbName);
		String rdsServicePayload = CloudEnvironmentTestHelper.getRdsServicePayload("n/a", "rds-mysql", "127.0.0.1", 3306,
				username, password, dbName);
		String cleardbServicePayload = CloudEnvironmentTestHelper.getCleardbServicePayload("n/a", "cleardb-dev", "127.0.0.1", 3306,
				username, password, dbName);
		String[] payloads = new String[]{mysqlServicePayload, rdsServicePayload, cleardbServicePayload};
		...
		for (String payload: payloads) {
			...
			assertEquals("not the correct username", username, dataSourceWithPoolAndConnProps.getPropertyValue("username"));
			assertEquals("not the correct password", password, dataSourceWithPoolAndConnProps.getPropertyValue("password"));
