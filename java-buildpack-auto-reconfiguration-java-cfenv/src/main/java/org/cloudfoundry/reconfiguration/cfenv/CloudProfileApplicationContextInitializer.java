...
import static org.cloudfoundry.reconfiguration.cfenv.ProfileUtils.activateProfile;
...
public final class CloudProfileApplicationContextInitializer implements ApplicationContextInitializer<ConfigurableApplicationContext>, Ordered {
    ...
    public void initialize(ConfigurableApplicationContext applicationContext) {
        activateProfile("cloud", applicationContext.getEnvironment(), this.cfEnvHolder);
    }
