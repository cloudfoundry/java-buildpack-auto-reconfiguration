...
public class ServiceController {
	...
	public @ResponseBody
	ResponseEntity<Properties> getServiceProperties() {
		if (serviceHolder.getServiceProperties() == null) {
			return new ResponseEntity<Properties>(HttpStatus.NOT_FOUND);
		}
		return new ResponseEntity<Properties>(serviceHolder.getServiceProperties(), HttpStatus.OK);
	}
