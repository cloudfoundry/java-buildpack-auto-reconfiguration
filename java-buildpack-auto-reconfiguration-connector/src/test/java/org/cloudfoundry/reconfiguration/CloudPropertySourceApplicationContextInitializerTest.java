...
public final class CloudPropertySourceApplicationContextInitializerTest {
    ...
    public void notInCloud() {
        ...
        new CloudPropertySourceApplicationContextInitializer(cloudHolder).initialize(applicationContext);

        assertThat(environment.getPropertySources().contains("cloud")).isFalse();
    }
    ...
    public void profileActivated() {
        ...
        assertThat(environment.getPropertySources().contains("cloud")).isTrue();
    }
