...
public final class CloudProfileApplicationListenerTest {
    ...
    public void notInCloud() {
        ...
        new CloudProfileApplicationListener(cloudHolder).onApplicationEvent(new ApplicationEnvironmentPreparedEvent(new SpringApplication(), new String[0], environment));
