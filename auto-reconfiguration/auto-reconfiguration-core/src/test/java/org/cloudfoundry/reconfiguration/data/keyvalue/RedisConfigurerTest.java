...
public class RedisConfigurerTest extends CloudEnvironmentMockingTest {
	...
	public void doesNothingIfRedisConnFactoryClassNotFound() {
		RedisConfigurer configurer = new MockRedisConfigurer(mockEnvironment, serviceCreator);
		assertFalse(configurer.configure(beanFactory));
	}

	private class MockRedisConfigurer extends RedisConfigurer {
		public MockRedisConfigurer(CloudEnvironment cloudEnvironment, RedisServiceCreator serviceCreator) {
