...
public final class MySqlDataSourceCloudServiceBeanFactoryPostProcessorTest extends
    ...
    public MySqlDataSourceCloudServiceBeanFactoryPostProcessorTest() {
        super(AbstractDriverBasedDataSource.class, "mysql-datasource", SERVICE_INFO);
    }
    ...
    protected void assertLocalConfiguration(AbstractDriverBasedDataSource dataSource) {
        assertConfiguration(dataSource, "mysql://local-user:local-password@localhost:1234/local-database");
    }
