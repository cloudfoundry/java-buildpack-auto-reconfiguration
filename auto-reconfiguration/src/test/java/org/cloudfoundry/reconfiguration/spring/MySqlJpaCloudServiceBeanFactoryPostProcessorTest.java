...
public final class MySqlJpaCloudServiceBeanFactoryPostProcessorTest extends
    ...
    public MySqlJpaCloudServiceBeanFactoryPostProcessorTest() {
        super(EntityManagerFactory.class, "mysql-datasource", SERVICE_INFO);
    }
    ...
    protected void assertServiceConfiguration(EntityManagerFactory factory) {
        assertConfiguration(factory, "org.hibernate.dialect.MySQLDialect");
    }
