...
final class MessagingCloudServiceBeanFactoryPostProcessor implements BeanFactoryPostProcessor, Ordered {

    private final Cloud cloud;

    MessagingCloudServiceBeanFactoryPostProcessor(Cloud cloud) {
        this.cloud = cloud;
    }
