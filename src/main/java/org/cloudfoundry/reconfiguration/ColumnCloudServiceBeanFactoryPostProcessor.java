...
final class ColumnCloudServiceBeanFactoryPostProcessor implements BeanFactoryPostProcessor, Ordered {

    private final Cloud cloud;

    ColumnCloudServiceBeanFactoryPostProcessor(Cloud cloud) {
        this.cloud = cloud;
    }
