...
final class DocumentCloudServiceBeanFactoryPostProcessor implements BeanFactoryPostProcessor, Ordered {

    private final Cloud cloud;

    DocumentCloudServiceBeanFactoryPostProcessor(Cloud cloud) {
        this.cloud = cloud;
    }
