...
public final class MessagingCloudServiceBeanFactoryPostProcessorTest extends AbstractCloudServiceBeanFactoryPostProcessorTest {

    @Override
    BeanFactoryPostProcessor getBeanFactoryPostProcessor(Cloud cloud) {
        return new MessagingCloudServiceBeanFactoryPostProcessor(cloud);
    }
