...
public final class DocumentCloudServiceBeanFactoryPostProcessorTest extends AbstractCloudServiceBeanFactoryPostProcessorTest {

    @Override
    BeanFactoryPostProcessor getBeanFactoryPostProcessor(Cloud cloud) {
        return new DocumentCloudServiceBeanFactoryPostProcessor(cloud);
    }
