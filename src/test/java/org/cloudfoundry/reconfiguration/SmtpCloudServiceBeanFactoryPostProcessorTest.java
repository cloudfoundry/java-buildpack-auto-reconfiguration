...
public final class SmtpCloudServiceBeanFactoryPostProcessorTest extends AbstractCloudServiceBeanFactoryPostProcessorTest {

    @Override
    BeanFactoryPostProcessor getBeanFactoryPostProcessor(Cloud cloud) {
        return new SmtpCloudServiceBeanFactoryPostProcessor(cloud);
    }
