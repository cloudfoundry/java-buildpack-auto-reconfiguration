...
public final class ColumnCloudServiceBeanFactoryPostProcessorTest extends AbstractCloudServiceBeanFactoryPostProcessorTest {

    @Override
    BeanFactoryPostProcessor getBeanFactoryPostProcessor(Cloud cloud) {
        return new ColumnCloudServiceBeanFactoryPostProcessor(cloud);
    }
